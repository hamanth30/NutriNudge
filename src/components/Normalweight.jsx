...
const food = [
  ...
  {
    img1: "https://cdn.loveandlemons.com/wp-content/uploads/2019/09/oatmeal.jpg",
    name: "Oat meal",
  },
  {
  ...
  {
    img1: "https://shwetainthekitchen.com/wp-content/uploads/2023/06/veg-fried-rice.jpg",
    name: "Fried Rice",
  },
  {
    img1: "https://www.spiceindiaonline.com/wp-content/uploads/2021/05/Tandoori-Chicken-20.jpg",
    name: "Grilled Chicken",
  },
  {
    img1: "https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_16:9/k%2FPhoto%2FRecipes%2F2024-04-green-beans%2Fgreen-beans-077",
    name: "Beans",
  },
];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-red-200">
      ...
      <div className="w-full max-w-7xl h-auto p-10 bg-red-100 rounded-lg shadow-lg text-center">
        <h1 className="text-2xl font-bold text-red-600">Normal Weight Diet Plan</h1>
        <p className="mt-4">Here’s a recommended diet plan to help you to maintain your weight and stay fit:</p>
        <ul className="list-disc mt-4 text-left mx-auto max-w-lg">
          <li>Stay in balanced calories intake.</li>
          <li>Take combination of all nutrients in your food</li>
          <li>Equal amounts of carbohydrates, fats, proteins and fibre</li>
        </ul>
